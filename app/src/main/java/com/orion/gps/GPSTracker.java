...
public class GPSTracker extends Service implements LocationListener {
    ...
    private final Context mContext;                                        //Declaring a Context
    ...
    protected LocationManager mLocationManager;                            //Declaring a Location Manager
    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 2;        //The minimum distance to change Updates in meters: 2
    ...
    public Location getLocation() {
        try {
            ...
            if (!mIsGPSEnabled && !mIsNetworkEnabled) {
                ...
                this.mCanGetLocation = (mLocation != null);
            }
